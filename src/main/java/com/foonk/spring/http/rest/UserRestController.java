package com.foonk.spring.http.rest;
...
public class UserRestController {
    ...
    public UserReadDto create(@Validated({Default.class}) @RequestBody UserCreateEditDto user) {
        return userService.create(user);
    }

    @PutMapping("/{id}")
    public UserReadDto update(@PathVariable("id") Long id,
                              @Validated({Default.class}) @RequestBody UserCreateEditDto user) {
